    ...
    <x-slot name="content">
        ...
        <div class="flex items-center mt-5">
            <x-jet-button wire:click="confirmLogout" wire:loading.attr="disabled">
                {{ __('Cerrar sesión en los demás navegadores') }}
            </x-jet-button>
        ...
        <x-jet-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="content">
                {{ __('Porfavor ingresa tu contraseña para confirmar si quieres cerrar sesión en los demás navegadores de todos tus dispositivods.') }}
